...
do
	...
	vsearch --fastq_filter ${a}.assembled.fastq -fastaout ${a}.asmbld.fasta
	vsearch --fastq_filter ${a}.unassembled.forward.fastq -fastaout ${a}.asmbld.forw.fasta
	vsearch --fastq_filter ${a}.unassembled.reverse.fastq -fastaout ${a}.asmbld.rev.fasta	
done
